...
# %% auto 0
__all__ = ['get_docker_command', 'copy_a3m', 'get_AF_input_seq', 'write_json', 'read_json', 'a3m_to_seq', 'get_protein_json',
           'get_AF_input', 'save_json', 'generate_pair_df', 'save_json_nfolder', 'get_AF_input_smi', 'save_input_smi']
...
def copy_a3m(a3m_dir: str, # Path to the source directory containing .a3m files.
    ...
    files = list(a3m_dir.glob(file_format))
