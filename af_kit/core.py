...
# %% auto 0
__all__ = ['get_docker_command', 'copy_a3m', 'get_AF_input_seq', 'dump_json', 'read_json', 'a3m_to_seq', 'get_protein_json',
           'save_json', 'get_AF_input', 'generate_pair_df', 'split_nfolder', 'get_AF_input_smi', 'save_input_smi']
