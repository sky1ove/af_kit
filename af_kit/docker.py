# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_docker.ipynb.

# %% auto 0
__all__ = ['get_docker_command', 'docker_single_protein_default', 'docker_virtual_screening']

# %% ../nbs/01_docker.ipynb 3
from fastcore.meta import delegates

# %% ../nbs/01_docker.ipynb 6
...
# %% ../nbs/01_docker.ipynb 12
@delegates(get_docker_command)
def docker_single_protein_default(json_path,output_dir,cache_dir=False,**kwargs):
...
# %% ../nbs/01_docker.ipynb 14
@delegates(get_docker_command)
def docker_virtual_screening(input_dir,output_dir,skip_search=True, json_path=None,**kwargs):
    return get_docker_command(
        input_dir=input_dir,
        output_dir=output_dir,
